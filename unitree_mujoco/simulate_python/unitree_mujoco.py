...
# context = mujoco.MjrContext(mj_model, mujoco.mjtFontScale.mjFONTSCALE_150.value)
# opt = mujoco.MjvOption()                        # visualization options
# cam = mujoco.MjvCamera() 
# # cam_id = mujoco.mj_name2id(mj_model, mujoco.mjtObj.mjOBJ_CAMERA)
# print("yha")
# cam_id = mj_model.camera("robot_camera").id
...
def SimulationThread():
    ...
    while viewer.is_running():
        ...
        locker.acquire()
        # mujoco.mjv_updateScene(mj_model, mj_data, opt, None, cam, mujoco.mjtCatBit.mjCAT_ALL.value, scene)
